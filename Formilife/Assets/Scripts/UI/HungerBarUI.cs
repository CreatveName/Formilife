...
// Drives a three-layer hunger bar (outline + fill + background) from an
...
{
    [Header("Refs")]
    [SerializeField] private AntNeeds needs;   // whose hunger to show
    ...
    private void Update()
    {
        ...
        float target = Mathf.Clamp01(needs.GetHungerNormalized());
